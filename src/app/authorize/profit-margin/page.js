...
export default function ProfitMarginPage() {
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-black/30 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent bg-white text-[#2D1B2E] text-sm"
              >
  ...
  const SummaryCard = ({ title, value, subtitle, icon, color }) => (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-black/20 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between">
        <div>
          <p className="text-sm text-black/70 font-medium">{title}</p>
          <p className="text-2xl font-bold text-[#2D1B2E] mt-1">{value}</p>
          {subtitle && (
            <p className="text-xs text-black/70 mt-1">{subtitle}</p>
          )}
        </div>
      ...
      <div className="overflow-x-auto rounded-xl border border-black/20">
        <table className="w-full text-xs">
          <thead className="bg-[#FDF7EF]">
            <tr>
              <th className="px-3 py-2 text-left text-[10px] font-medium text-black/70 uppercase tracking-wider">Variant / Sub-Variant</th>
              <th className="px-3 py-2 text-center text-[10px] font-medium text-black/70 uppercase tracking-wider">Qty</th>
              <th className="px-3 py-2 text-right text-[10px] font-medium text-black/70 uppercase tracking-wider">Revenue</th>
              <th className="px-3 py-2 text-right text-[10px] font-medium text-black/70 uppercase tracking-wider">Cost</th>
              <th className="px-3 py-2 text-right text-[10px] font-medium text-black/70 uppercase tracking-wider">Profit</th>
              <th className="px-3 py-2 text-center text-[10px] font-medium text-black/70 uppercase tracking-wider">Margin</th>
            </tr>
          </thead>
          <tbody>
            {allRows.map((row, idx) => {
              ...
              return (
                ...
                >
                  <td className={`px-3 py-2 ${isSubRow ? 'pl-8' : 'pl-4'}`}>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className={`text-xs ${
                        isSubRow ? 'text-gray-600' : 'font-medium text-black'
                      }`}>
                        {isSubRow ? row.subVariantName : row.variantName}
                      </span>
                      {!isSubRow && (
                        <span className="text-[8px] px-1.5 py-0.5 rounded bg-black/15 text-black">
                          Variant
                        </span>
                      )}
                      {isSubRow && (
                    ...
                    {isSubRow && (
                      <p className="text-[9px] text-black/70 ml-4 mt-0.5">
                        {row.variantName}
                      </p>
                    )}
                  </td>
                  ...
                  <td className="px-3 py-2 text-right text-xs font-medium">
                    <span className={rowProfit > 0 ? 'text-emerald-600' : rowProfit < 0 ? 'text-red-600' : 'text-black/70'}>
            ...
            <tr className="border-t-2 border-black/40 bg-[#FDF7EF]">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 bg-gradient-to-r from-black to-black rounded-xl flex items-center justify-center shadow-lg shadow-black/25">
              ...
              <div>
                ...
                <p className="text-sm text-black/70">
                  ...
                  <span className="ml-2 text-xs text-black font-medium bg-[#FDF7EF] px-2 py-0.5 rounded-full border border-black/30">
                    {getPeriodLabel()}
                  </span>
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 border rounded-xl transition-colors text-sm ${
                  showFilters ? 'bg-black text-white border-black' : 'bg-white border-black/30 text-[#2D1B2E] hover:bg-[#FDF7EF]'
                }`}
              >
          ...
          {/* Filters */}
          {showFilters && (
            <div className="bg-white rounded-2xl border border-black/20 shadow-sm overflow-hidden mb-6">
              {/* Period Type Tabs */}
              <div className="p-4 border-b border-black/20 bg-[#FDF7EF]">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs font-medium text-black/70 mr-2">View by:</span>
                  <button
                    onClick={() => setPeriod('day')}
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5 ${
                      period === 'day' ? 'bg-black text-white shadow-sm' : 'bg-white text-[#2D1B2E] hover:bg-[#FDF7EF] border border-black/30'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5 ${
                      period === 'week' ? 'bg-black text-white shadow-sm' : 'bg-white text-[#2D1B2E] hover:bg-[#FDF7EF] border border-black/30'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5 ${
                      period === 'month' ? 'bg-black text-white shadow-sm' : 'bg-white text-[#2D1B2E] hover:bg-[#FDF7EF] border border-black/30'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5 ${
                      period === 'year' ? 'bg-black text-white shadow-sm' : 'bg-white text-[#2D1B2E] hover:bg-[#FDF7EF] border border-black/30'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1.5 ${
                      period === 'custom' ? 'bg-black text-white shadow-sm' : 'bg-white text-[#2D1B2E] hover:bg-[#FDF7EF] border border-black/30'
                    }`}
                  >
                    Custom
                  </button>
              ...
              {/* Quick Stats */}
              {data && (
                <div className="px-4 py-3 bg-[#FDF7EF] border-t border-black/20 grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="text-center">
                    <p className="text-[10px] text-black/70 uppercase tracking-wide">Period</p>
                    <p className="text-sm font-semibold text-[#2D1B2E]">{getPeriodLabel()}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-[10px] text-black/70 uppercase tracking-wide">Product Orders</p>
                    <p className="text-sm font-semibold text-[#2D1B2E]">{data.summary.totalOrders}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-[10px] text-black/70 uppercase tracking-wide">Revenue</p>
                    <p className="text-sm font-semibold text-emerald-600">{formatCurrency(data.summary.totalRevenue)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-[10px] text-black/70 uppercase tracking-wide">Profit</p>
          ...
          {/* Loading State */}
          {loading && (
            <div className="bg-white rounded-2xl p-12 text-center border border-black/20">
              <FaSpinner className="w-8 h-8 text-black animate-spin mx-auto mb-4" />
              <p className="text-black/70">Calculating profit margins...</p>
            </div>
          )}
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <SummaryCard
                  ...
                  icon={<FaShoppingCart className="w-5 h-5 text-black" />}
                  color="bg-[#FDF7EF]"
                />
                <SummaryCard
                  title="Total Revenue"
                ...
                <SummaryCard
                  ...
                  icon={<FaChartLine className="w-5 h-5 text-black" />}
                  color="bg-[#FDF7EF]"
                />
              </div>

              {/* Product Profit Breakdown */}
              <div className="bg-white rounded-2xl border border-black/20 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-black/20 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                  <div className="flex items-center gap-2">
                    <FaBox className="w-5 h-5 text-black" />
                    <h2 className="text-lg font-semibold text-[#2D1B2E]">Product Profit Breakdown</h2>
                    <span className="text-xs text-black/70 bg-[#FDF7EF] px-2 py-1 rounded-full border border-black/20">
                      {data.productProfitDetails.length} products
                    </span>
                    <span className="text-xs text-black bg-[#FDF7EF] px-2 py-1 rounded-full border border-black/30">
                      {getPeriodLabel()}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    <input
                      ...
                      className="flex-1 sm:w-48 px-3 py-1.5 border border-black/30 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent bg-[#FDF7EF] text-sm text-[#2D1B2E] placeholder:text-black/60"
                    />
                    <select
                      value={sortBy}
                      onChange={(e) => setSortBy(e.target.value)}
                      className="px-3 py-1.5 border border-black/30 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent bg-[#FDF7EF] text-sm text-[#2D1B2E]"
                    >
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-[#FDF7EF]">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-black/70">Product</th>
                        <th className="px-4 py-3 text-center text-xs font-medium text-black/70">Qty Sold</th>
                        <th className="px-4 py-3 text-right text-xs font-medium text-black/70">Revenue</th>
                        <th className="px-4 py-3 text-right text-xs font-medium text-black/70">Cost</th>
                        <th className="px-4 py-3 text-right text-xs font-medium text-black/70">Profit</th>
                        <th className="px-4 py-3 text-center text-xs font-medium text-black/70">Margin</th>
                        <th className="px-4 py-3 text-center text-xs font-medium text-black/70">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {filteredProducts.length === 0 ? (
                        <tr>
                          <td colSpan="7" className="px-4 py-8 text-center text-black/70 text-sm">
                            No products found
                          </td>
                        </tr>
                      ) : (
                        filteredProducts.map((product, index) => {
                          ...
                          return (
                            <tr key={index} className="border-b border-black/10 hover:bg-[#FDF7EF] transition-colors">
                                ...
                                <div className="flex items-center gap-3">
                                  {product.image ? (
                                    ...
                                    <div className="w-8 h-8 rounded-lg bg-[#FDF7EF] flex items-center justify-center">
                                      <FaBox className="w-4 h-4 text-black/60" />
                                    </div>
                                  )}
                                  <div>
                                    <div className="flex items-center gap-2">
                                      ...
                                      {product.hasVariants && variantCount > 0 && (
                                        <span className="text-[10px] px-1.5 py-0.5 rounded bg-black/15 text-black border border-black/30 whitespace-nowrap">
                              ...
                              <td className="px-4 py-3 text-right text-sm font-semibold">
                                <span className={isPositive ? 'text-emerald-600' : isNegative ? 'text-red-600' : 'text-black/70'}>
                                  {formatCurrency(product.totalProfit)}
                                </span>
                              </td>
                              ...
                              <td className="px-4 py-3 text-center">
                                <button
                                  ...
                                  className="text-black hover:text-black transition-colors text-xs flex items-center gap-1 mx-auto"
                                >
              ...
              {data.periodSummary && data.periodSummary.length > 0 && (
                <div className="bg-white rounded-2xl border border-black/20 shadow-sm overflow-hidden mt-6">
                  <div className="p-4 border-b border-black/20">
                    <h3 className="text-lg font-semibold text-[#2D1B2E] flex items-center gap-2">
                      <FaCalendarAlt className="w-5 h-5 text-black" />
                      Daily Performance
                      <span className="text-xs text-black/70 font-normal bg-[#FDF7EF] px-2 py-0.5 rounded-full border border-black/20">
                        {getPeriodLabel()}
                      </span>
                    </h3>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-[#FDF7EF]">
                        <tr>
                          <th className="px-4 py-2 text-left text-xs font-medium text-black/70">Date</th>
                          <th className="px-4 py-2 text-center text-xs font-medium text-black/70">Orders</th>
                          <th className="px-4 py-2 text-center text-xs font-medium text-black/70">Items</th>
                          <th className="px-4 py-2 text-right text-xs font-medium text-black/70">Revenue</th>
                          <th className="px-4 py-2 text-right text-xs font-medium text-black/70">Cost</th>
                          <th className="px-4 py-2 text-right text-xs font-medium text-black/70">Profit</th>
                          <th className="px-4 py-2 text-center text-xs font-medium text-black/70">Margin</th>
                        </tr>
                      </thead>
                      <tbody>
                        {data.periodSummary.map((day, index) => (
                          <tr key={index} className="border-b border-black/10 hover:bg-[#FDF7EF] transition-colors">
                            ...
                            <td className="px-4 py-2 text-center text-sm text-black/70">{day.itemsSold}</td>
                            ...
                            <td className="px-4 py-2 text-right text-sm font-semibold">
                              <span className={day.profit > 0 ? 'text-emerald-600' : day.profit < 0 ? 'text-red-600' : 'text-black/70'}>
                            ...
                            <td className="px-4 py-2 text-center">
                              <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${
                                ...
                                day.profitMargin > 0 ? 'bg-[#FDF7EF] text-black border border-black/30' :
                                day.profitMargin === 0 ? 'bg-black/15 text-black border border-black/30' :
              ...
              {showOrderDetails && selectedProduct && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                  <div className="bg-white rounded-2xl border border-black/20 shadow-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden">
                    <div className="p-4 bg-gradient-to-r from-black to-black text-white flex items-center justify-between">
                      <div>
                    ...
                    <div className="p-6 overflow-y-auto max-h-[65vh]">
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-[#FDF7EF] rounded-xl p-3 text-center border border-black/20">
                        ...
                        <div className="bg-[#FDF7EF] rounded-xl p-3 text-center border border-black/20">
                          <p className="text-xs text-black/70">Total Profit</p>
                        ...
                        <div className="bg-[#FDF7EF] rounded-xl p-3 text-center border border-black/20">
                          <p className="text-xs text-black/70">Quantity Sold</p>
                          <p className="text-xl font-bold text-[#2D1B2E]">{selectedProduct.totalQuantity}</p>
                        </div>
                        <div className="bg-[#FDF7EF] rounded-xl p-3 text-center border border-black/20">
                          <p className="text-xs text-black/70">Profit Margin</p>
                      ...
                      <div className="bg-[#FDF7EF] rounded-xl p-3 mb-4 border border-black/20">
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          <div>
                            <span className="text-black/70">Avg Selling Price:</span>
                            <span className="font-medium text-[#2D1B2E] ml-1">{formatCurrency(selectedProduct.averageSellingPrice)}</span>
                          </div>
                          <div>
                            <span className="text-black/70">Avg Cost Per Item:</span>
                      ...
                      {selectedProduct.hasVariants && selectedProduct.variantBreakdown && selectedProduct.variantBreakdown.length > 0 ? (
                        ...
                        <div className="text-xs text-black/70 bg-[#FDF7EF] p-3 rounded-lg border border-black/30">
                          <p className="font-medium text-black">Calculation</p>
                    ...
                    <div className="p-4 border-t border-black/20 bg-[#FDF7EF] flex justify-end">
                      <button
                        onClick={() => setShowOrderDetails(false)}
                        className="px-4 py-2 bg-gradient-to-r from-black to-black text-white rounded-xl hover:shadow-lg hover:shadow-black/25 transition-all text-sm shadow-md"
                      >
                        Close
                      </button>
                    </div>
